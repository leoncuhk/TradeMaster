"""DeepTrader快速测试配置 - 1 epoch"""

_base_ = [
    "../_base_/datasets/portfolio_management/dj30.py",
    "../_base_/environments/portfolio_management/env.py",
    "../_base_/agents/portfolio_management/deeptrader.py",
    "../_base_/trainers/portfolio_management/deeptrader_trainer.py",
    "../_base_/losses/mse.py",
    "../_base_/optimizers/adam.py",
    "../_base_/nets/deeptrader.py",
